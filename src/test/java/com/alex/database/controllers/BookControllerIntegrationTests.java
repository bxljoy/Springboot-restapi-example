...
public class BookControllerIntegrationTests {
        ...
        public void testThatCreateBookSuccessfullyReturnsSavedBook() throws Exception {
                ...
                mockMvc.perform(
                                ...
                                .andExpect(
                                                MockMvcResultMatchers.jsonPath("$.book_title").value("Java"));
        }
        ...
        public void testThatUpdateBookSuccessfullyReturnsSavedBook() throws Exception {
                ...
                mockMvc.perform(
                                ...
                                .andExpect(
                                                MockMvcResultMatchers.jsonPath("$.book_title")
        ...
        public void testThatListBooksReturnsPageOfBooks() throws Exception {
                ...
                mockMvc.perform(
                                ...
                                .andExpect(
                                                MockMvcResultMatchers.jsonPath("$.content[0].book_title")
                                                                .value("Java0"))
                                .andExpect(
        ...
        public void testThatGetBookReturnsBookWhenBookExists() throws Exception {
                ...
                mockMvc.perform(
                                ...
                                .andExpect(
                                                MockMvcResultMatchers.jsonPath("$.book_title").value("Kotlin"))
                                .andExpect(
